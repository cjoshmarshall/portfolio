        ...
        <div className='grid grid-cols-1 w-[80%] mx-auto my-6 gap-x-12 lg:grid-cols-2 lg:gap-x-20 xl:my-12 reveal'>
            <div className='flex flex-col'>
                <div className='m-3 xl:my-6'>
                    ...
                    <div className='flex justify-between items-baseline'>
                        <div className="w-[85%] h-3 mb-4 bg-gray-500 rounded-full sm:w-[88%]">
                            <div id='progress' className="w-4/5 h-3 bg-white rounded-full"></div>
                        </div>
                ...
                <div className='m-3 xl:my-6'>
                    ...
                    <div className='flex justify-between items-baseline'>
                        <div className="w-[85%] h-3 mb-4 bg-gray-500 rounded-full sm:w-[88%]">
                            <div className="w-[225px] h-3 bg-white rounded-full"></div>
                        </div>
                ...
                <div className='m-3 xl:my-6'>
                    ...
                    <div className='flex justify-between items-baseline'>
                        <div className="w-[85%] h-3 mb-4 bg-gray-500 rounded-full sm:w-[88%]">
                            <div className="w-[250px] h-3 bg-white rounded-full"></div>
                        </div>
                ...
                <div className='m-3 xl:my-6'>
                    ...
                    <div className='flex justify-between items-baseline'>
                        <div className="w-[85%] h-3 mb-4 bg-gray-500 rounded-full sm:w-[88%]">
                            <div className="w-[205px] h-3 bg-white rounded-full"></div>
                        </div>
